/**棋盘 */
var box = document.querySelector('#box') as HTMLDivElement;
/**悔棋按钮*/
...
/**棋盘规格*/
var sizeNumber: number = 21;
/**每隔大小*/
var size: number = 27;
/** 棋子半径*/
var qizir = 10;
/** 棋盘x轴位置 */
var boxleft: number = box.offsetLeft
/**棋盘y轴位置 */ 
var boxtop: number = box.offsetTop;
/**棋子颜色 */
var qiziColor: string = 'red';
/**棋子信息*/
var qiziData: any[] = [];
/**已悔棋的数据 */
var huiqiData: any[] = [];
...
var lianqiArry:number[] = [1,1,1,1]
/**棋盘上位置的颜色信息 */
var data: any[] = new Array(sizeNumber);
